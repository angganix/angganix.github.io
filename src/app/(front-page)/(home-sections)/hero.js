...
const Hero = () => {
  return (
    <section
      id="hero"
      className="px-4 lg:px-0 bg-gradient-to-b from-lime-300 to-lime-50 min-h-max overflow-hidden"
    >
            ...
            <div className="flex flex-col justify-center items-center h-full">
              ...
              <div className="flex items-center gap-x-1 justify-center">
                <Link
                  ...
                  className="rounded-full p-2 border border-neutral-100 hover:bg-neutral-200 transition-all duration-200 ease-in-out"
                  title="Github"
                >
                  <FaGithub size={28} />
                </Link>
