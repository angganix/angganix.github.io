...
const Home = () => {
  return (
    <>
      <section
        id="hero"
        className="px-4 lg:px-0 bg-white min-h-max overflow-hidden"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="col-span-12 lg:col-span-7 py-12 lg:py-24 order-last lg:order-first">
              <div className="flex flex-col justify-center h-full">
                ...
                <p className="font-light mb-5">
                  ...
                  <strong>
                    {" "}
                    Network Engineer, Server Administrator, dan Software
                    Engineer
                  </strong>
                  .
                </p>
            ...
            <div className="col-span-12 lg:col-span-5 order-first lg:order-last">
              <div className="flex flex-col justify-center items-center h-full">
                <div className="rounded-full overflow-hidden bg-gradient-to-t from-lime-600 via-lime-50 to-transparent relative w-72 h-72 mt-8 lg:mt-0 mb-3">
                  <Image
                ...
                <div className="flex items-center gap-x-1 justify-center">
                  <Link
                    ...
                    className="rounded-full p-2 border border-neutral-100 hover:bg-neutral-100 transition-all duration-200 ease-in-out"
                    title="Github"
                  >
                    <FaGithub size={28} />
                  </Link>
